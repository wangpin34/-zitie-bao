          ...
          <Grid rows="auto auto" gap="4" className="bg-white p-4 rounded-xl">
            ...
            <Flex width="full" direction="column" gap="2" align="end">
              <Flex align="center" className="capitalize" width="20" gap="1">
                ...
                <Select.Root value={font} onValueChange={(next: FontFamily) => setFont(next)}>
                  <Select.Trigger placeholder="选择字体" />
                  <Select.Content>
                    {FONT_FAMILY.map((font, index) => (
                      <Select.Item key={index} value={font} className="capitalize">
                        {font}
                      </Select.Item>
                    ))}
                  </Select.Content>
             ...
             <Flex width="full" align="center" justify="center">
                <Text size="2">Made by&nbsp;@<a href="https://github.com/wangpin34" target="__blank" className="text-[var(--red-8)]">Penn</a></Text>
              </Flex>
          </Grid>
        </div>
      </div>
